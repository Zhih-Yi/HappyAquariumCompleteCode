          ...
          <div class="row g-0">
            <div class="col-6 col-sm-3">
              <router-link to="/product/水草">
                ...
                v-lazy:background-image="require('@/assets/images/水草.png')">
...
import CardGroup from '@/components/frontend/CardGroup.vue'
