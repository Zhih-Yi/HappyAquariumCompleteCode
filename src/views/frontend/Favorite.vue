            ...
            <div class="row my-2 py-2 align-items-center" v-for="item in products" :key="item.id" v-cloak >
              ...
              <div class="col-6 col-sm-8 col-md-9 col-lg-9">
                <div class="row align-items-center">
                  ...
                  <div class="col-md-8">
                    <button type="button" class="btn btn-primary btn-hv-style me-3" @click="goToContent(item.id)">
                      <span class="d-none d-sm-inline-block me-2">查看更多</span>
                      <i class="fas fa-angle-double-right"></i>
                    </button>
                    <button type="button" class="btn btn-secondary btn-hv-style me-3" :id="item.id" @click="addToCart(item)">
                      <span class="d-none d-sm-inline-block me-2">加入購物車</span>
