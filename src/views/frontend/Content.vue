...
<div>
  <div class="img-header d-flex justify-content-center align-items-center">
    ...
    <h2 class="img-header-title"><strong>商品內容</strong></h2>
  </div>
  ...
  <div class="container py-5">
    <div class="row">
       <div class="col-2 pt-1 pb-3">
        <a href="#" @click.prevent="historyBack"><i class="fas fa-arrow-left fa-2x text-third"></i></a>
      </div>
    </div>
    <div class="row">
      <div class="col-md-6">
        ...
        <div class="row">
          <div class="col-6">
            <div class="input-group mb-3">
              <button class="btn border border-2" @click="minusQuantity" type="button" id="minus"><strong class="h4">−</strong></button>
              <input type="number"  class="form-control" v-model.number="quantity" @change="VerifyNumber">
              <button class="btn border border-2" @click="addQuantity" type="button" id="plus"><strong class="h4">+</strong></button>
            </div>
          </div>
        </div>
        <div class="row">
