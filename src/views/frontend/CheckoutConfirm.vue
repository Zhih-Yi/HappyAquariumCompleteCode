              ...
              <div class="row align-items-center">
                ...
                <div class="col-md-5 col-sm-5 col-12">
                  <div class="input-group input-group-sm input-group-fixed mb-3">
                    <button type="button" class="btn border border-secondary" @click="minusQuantity(item)" id="minus">
                      <strong class="h4">−</strong>
                    </button>
                    <input type="number"  class="form-control" v-model.number="item.qty" @change="verifyNumber(item)">
                    <button type="button" class="btn border border-secondary" @click="addQuantity(item)" id="plus">
                      <strong class="h4">+</strong>
                    </button>
                  </div>
                </div>
