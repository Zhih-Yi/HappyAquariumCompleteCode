...
<div class="footer">
  ...
  <div class="row ">
    <div class="col-lg-9 col-md-8">
      <p class="display-6"
      > <i class="fas fa-fish text-primary me-2"></i><strong  class="text-info ">快樂水族</strong>
</p>
...
<script async defer crossorigin="anonymous" src="https://connect.facebook.net/zh_TW/sdk.js#xfbml=1&version=v10.0" nonce="3hzaJt65"></script>
<script>
